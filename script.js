...
const quiz = [
...

  {
    ...
    option1: "It triggers when the web page is first loaded in the browser.",
    option2: "It triggers when the DOM tree has finished loading and parsing.",
    option3: "It triggers when the user clicks on an element.",
    option4: "It triggers when an external CSS file is loaded.",
    correct: "b",
  },
...

  {
    ...
    option1: "To target specific devices and apply different styles based on their characteristics.",
    option2: "To embed multimedia content, such as videos and audio files, in a web page.",
    option3: "To create animated effects using CSS transitions and animations.",
    option4: "To write comments in CSS code to explain the styling rules.",
    correct: "a",
  },
  ...
  {
    question: "Why would you surround a piece of text with",
    option1: "To indicate that this text is the main heading on the page",
    option2: "To make the text bold",
    option3: " To ensure that search engines treat the keywords as being important for this page",
    option4: "To demonstrate to screen readers that this text is important",
    correct: "a",
  },
